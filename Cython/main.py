...
from fluid_dynamics import equilibrium, collision, stream_and_reflect, fluid_density, fluid_velocity
...
def main():
    ...
    force_array = np.zeros((sim.t_steps), dtype=np.float64) #initialising the array which will store the force throughout the whole simulation
...
if __name__ == "__main__":
    ...
    print('TOTAL TIME OF MAIN(): ', time_end - time_start)
