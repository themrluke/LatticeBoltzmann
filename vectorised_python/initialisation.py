...
class InitialiseSimulation:
    ...
    def initialise_turbulence(self, choice):
        """
        ...
        r = np.random.uniform(random_range[0], random_range[1], (sim.num_x, sim.num_y)) # These values will alter angle of incoming fluid, leading to faster turbulent flow
